...
{
    public partial class uscDanhMuc : UserControl
    {
        ...
        private void uscDanhMuc_Load(object sender, EventArgs e)
        {
            LayDuLieu();
        }
